 ...
 * <p>Especially useful for {@link de.***REMOVED***.kopfkino.Vector2f}, {@link
 * de.***REMOVED***.kopfkino.Dimensions}
 * and {@link de.***REMOVED***.kopfkino.BoundingBox} as the reading and writing is done
 * out of the box.
