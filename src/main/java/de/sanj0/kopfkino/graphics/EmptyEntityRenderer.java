 ...
 * <p>Useful for invisible {@link de.***REMOVED***.kopfkino.Entity}s or
 * for when only the methods {@link de.***REMOVED***.kopfkino.Entity#renderAfter(KopfkinoGraphics)}
 * and / or {@link de.***REMOVED***.kopfkino.Entity#renderBefore(KopfkinoGraphics)} are needed
