...
/**
 * A mathematical Function, that return a float between 0 and 1 for every given
 * float between 0 and 1.
 * <p>Used for easing by {@link KeyframeAnimation}s.
 * <p>Provides basic implementation for "sine", "exponential", "bounce" and
 * "elastic",
 * inspired by easings.net (GPT3).
 */
public interface TransitionFunction extends Function<Float, Float> {
     ...
     *
     * @return the inverse of this transition
     */
